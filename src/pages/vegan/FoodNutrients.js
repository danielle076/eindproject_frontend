    ...
    return (
        <main className='main-vegan'>
            ...
            <section className='nutrients-vegan'>
                ...
                <ul>
                    <li className='tooltip-vegan'>Calories: {nutrients.calories.toFixed(0)}
                        <span className='tooltiptext'>A calorie is a unit of energy.</span>
                    </li>
                    <li className='tooltip-vegan'>Carbohydrates: {nutrients.carbohydrates.toFixed(0)}
                    ...
                    <li className='tooltip-vegan'>Fat: {nutrients.fat.toFixed(0)}
                    ...
                    <li className='tooltip-vegan'>Protein: {nutrients.protein.toFixed(0)}
