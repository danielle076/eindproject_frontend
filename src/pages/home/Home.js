    ...
    return (
        <>
            <main>
                <div className='home-container'>
                    <article className='article-home'>
                        ...
                        <p className='p-home'>
                            There's nothing like that first day of warm weather. At first you are happy that you can
                            finally
                        ...
                        <p className='p-home'>
                            Don't panic. Not only is there still plenty of time to prepare, but to get yourself
                            beach-body
                        ...
                        <p className='p-home'>
                            ...
                            nutritionally. Whether you are vegan, vegetarian or an all-eater, we are here to save your
                            day.
                        ...
                        <p className='p-home'>
                            All you have to do is click on the link of the meal to see what ingredients you need and how
                            to
            ...
            <footer className='footer-container'>
                <p>Heb je vragen of suggesties, <a href="mailto:d.vandenakker@novi-education.nl" className='home-email'>e-mail</a> ons.</p>
            </footer>
        </>
    );
}
